...
<div class="flex flex-1 bg-teal-800 items-center justify-between py-2 px-[28px]">
    <div class="flex items-center">
        ...
        <!-- Make the title of the website a clickable link to the homepage -->
        <a href="index.php" class="py-3 px-5 text-3xl font-semibold text-white">
            BookChor
        </a>
    </div>

    <form action="index.php" class="flex w-[500px]">
        <input type="search" name="search" placeholder="Search book by title, author, ISBN..." class="border px-3 py-2 w-full rounded bg-slate-200 outline-none border-none">
    ...
    <div class="flex items-center gap-5 px-4">
        ...
        <!-- Conditionally show Signup/Login or User Dropdown -->
